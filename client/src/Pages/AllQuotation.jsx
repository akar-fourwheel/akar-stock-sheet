  ...
  <tbody>
    {sortedQuotaData.map((row) => (
      <tr key={row} className="border-b hover:bg-gray-50">
        <td className="sm:px-4 sm:py-3 px-1 py-2 text-sm sm:text-base font-medium text-gray-900">{row[0]}</td>
        <td className="sm:px-4 sm:py-3 px-1 py-2 text-sm sm:text-base text-gray-700">{row[1]}</td>
        <td className="sm:px-4 sm:py-3 px-1 py-2 text-sm w-[50px] w-24 sm:text-base text-gray-700">{row[2]}</td>
        <td className="sm:px-4 sm:py-3 px-1 py-2 text-sm w-[50px] w-24 sm:text-base text-gray-700">{row[3]}</td>
